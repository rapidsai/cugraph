...
pytest \
  --pyargs nx_cugraph \
  --config-file=../nx-cugraph/pyproject.toml \
  --cov-config=../nx-cugraph/pyproject.toml \
  --cov=nx_cugraph \
  --cov-append \
  --cov-report=
coverage report \
  ...
  --omit=__init__.py \
  --show-missing \
  --rcfile=../nx-cugraph/pyproject.toml
coverage json --rcfile=../nx-cugraph/pyproject.toml
