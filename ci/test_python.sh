...
PYTEST_NO_SKIP=True ./run_nx_tests.sh -k --cov-append "TestDAG and test_antichains"
PYTEST_NO_SKIP=True ./run_nx_tests.sh -k --cov-append "TestMultiDiGraph_DAGLCA and test_all_pairs_lca_pairs_without_lca"
PYTEST_NO_SKIP=True ./run_nx_tests.sh -k --cov-append "TestDAGLCA and test_all_pairs_lca_pairs_without_lca"
PYTEST_NO_SKIP=True ./run_nx_tests.sh -k --cov-append "TestEfficiency and test_using_ego_graph"
