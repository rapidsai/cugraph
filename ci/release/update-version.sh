...
for FILE in conda/environments/*.yml; do
   ...
   sed_runner "s/raft-dask=${CURRENT_SHORT_TAG}/libraft-headers=${NEXT_SHORT_TAG}/g" ${FILE};
   sed_runner "s/pylibraft=${CURRENT_SHORT_TAG}/libraft-headers=${NEXT_SHORT_TAG}/g" ${FILE};
