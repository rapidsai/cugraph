...
sed_runner "s/${CURRENT_SHORT_TAG}/${NEXT_SHORT_TAG}/g" python/cugraph/setup.py
sed_runner "s/${CURRENT_SHORT_TAG}/${NEXT_SHORT_TAG}/g" python/cugraph/_custom_build/backend.py
sed_runner "s/${CURRENT_SHORT_TAG}/${NEXT_SHORT_TAG}/g" python/pylibcugraph/setup.py
sed_runner "s/${CURRENT_SHORT_TAG}/${NEXT_SHORT_TAG}/g" python/pylibcugraph/_custom_build/backend.py
