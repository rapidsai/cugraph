...
def heterogeneous_biased_temporal_neighbor_sample(ResourceHandle resource_handle,
    ...
    error_code = cugraph_heterogeneous_biased_temporal_neighbor_sample(
        ...
        &result_ptr,
        &error_ptr)
    assert_success(error_code, error_ptr, "cugraph_heterogeneous_biased_temporal_neighbor_sample")
