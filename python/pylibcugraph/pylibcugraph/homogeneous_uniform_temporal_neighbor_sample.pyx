...
def homogeneous_uniform_temporal_neighbor_sample(ResourceHandle resource_handle,
    ...
    >>> sampling_results = pylibcugraph.homogeneous_uniform_temporal_neighbor_sample(
    ...         resource_handle, G, None, start_vertices, None, h_fan_out, False, True)
    >>> sampling_results
    {'majors': array([2, 2, 5, 5], dtype=int32),
     'minors': array([1, 3, 3, 4], dtype=int32),
     'weight': array([3.1, 4.1, 7.2, 3.2], dtype=float32),
     'edge_start_time': array([9, 10, 6, 7], dtype=int32),
     'edge_end_time': array([10, 11, 7, 8], dtype=int32)}
    ...
    {'majors': array([2, 2, 5, 5, 1, 1], dtype=int32),
     'minors': array([0, 3, 3, 4, 0, 3], dtype=int32),
     'weight': array([5.1, 4.1, 7.2, 3.2, 0.1, 2.1], dtype=float32),
     'edge_start_time': array([11, 10, 6, 7, 0, 3], dtype=int32),
     'edge_end_time': array([12, 11, 7, 8, 1, 4], dtype=int32),
