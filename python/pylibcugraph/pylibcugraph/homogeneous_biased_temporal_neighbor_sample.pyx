...
def homogeneous_biased_temporal_neighbor_sample(ResourceHandle resource_handle,
    ...
    {'majors': array([2, 2, 5, 5], dtype=int32),
     ...
     'weight': array([5.1, 3.1, 7.2, 3.2], dtype=float32),
     'edge_start_time': array([11, 9, 6, 7], dtype=int32),
     'edge_end_time': array([12, 10, 7, 8], dtype=int32)}
    ...
    {'majors': array([2, 2, 5, 5, 1, 1], dtype=int32),
     'minors': array([0, 3, 3, 4, 2, 3], dtype=int32),
     'weight': array([5.1, 4.1, 7.2, 3.2, 3.1, 2.1], dtype=float32),
     'edge_start_time': array([11, 10, 6, 7, 8, 3], dtype=int32),
     'edge_end_time': array([12, 11, 7, 8, 9, 4], dtype=int32),
     'batch_id': array([0, 0, 0, 0, 1, 1], dtype=int32),
    ...
    error_code = cugraph_homogeneous_biased_temporal_neighbor_sample(
        ...
        &result_ptr,
        &error_ptr)
    assert_success(error_code, error_ptr, "cugraph_homogeneous_biased_temporal_neighbor_sample")
