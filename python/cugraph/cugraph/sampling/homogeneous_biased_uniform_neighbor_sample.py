...
from pylibcugraph import homogeneous_biased_neighbor_sample as \
...
def ensure_valid_dtype(input_graph, start_vertex_list):
    ...
    if start_vertex_list_dtypes != vertex_dtype:
        warning_msg = (
            "biased neighbor sample requires 'start_vertex_list' to match the graph's "
...
def homogeneous_biased_neighbor_sample(
    ...
    The edges are sample with biases.
