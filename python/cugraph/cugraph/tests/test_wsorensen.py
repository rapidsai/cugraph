...
def test_wsorensen(gpubenchmark, graph_file):
    gc.collect()
...
@pytest.mark.parametrize("graph_file", utils.DATASETS_UNDIRECTED)
def test_nx_wsorensen_time(gpubenchmark, graph_file):
...
@pytest.mark.parametrize("graph_file", utils.DATASETS_UNDIRECTED)
def test_wsorensen_multi_column_weights(gpubenchmark, graph_file):
    gc.collect()
...
@pytest.mark.parametrize("graph_file", utils.DATASETS_UNDIRECTED)
def test_wsorensen_multi_column(graph_file):
    gc.collect()
