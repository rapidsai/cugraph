...
def run_test_dist_sampler_simple(rank, world_size, uid, samples_path, batch_size, seeds_per_rank, fanout, equal_input_size):
    ...
    sampler.sample_from_nodes(
        ...
        assume_equal_input_size=equal_input_size
    )
