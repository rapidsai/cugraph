...
def pagerank(G,alpha=0.85, personalization=None, max_iter=100, tol=1.0e-5, nstart=None):
    """
    ...
    df = cpp_pagerank.pagerank(G.graph_ptr, alpha, personalization, max_iter, tol, nstart)
