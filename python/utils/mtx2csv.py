...
parser = argparse.ArgumentParser(description='Convert the sparsity pattern of a MatrixMarket file into a CSV file. Each directed edge is explicitely stored, edges are unsorted, vertices IDs are 0-based.')
...
# Write
print ('Writing CSV file: '+ os.path.splitext(os.path.basename(args.file))[0] + '.csv ...')
t1 = time.time()
