...
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(void, int32_t, false);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(void, int32_t, true);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(void, int64_t, false);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(void, int64_t, true);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(int32_t, int32_t, false);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(int32_t, int32_t, true);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(int32_t, int64_t, false);
CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY(int32_t, int64_t, true);

#undef CUGRAPH_INSTANTIATE_TEMPORAL_SAMPLE_UNVISITED_WITH_ONE_PROPERTY
