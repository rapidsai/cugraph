...
// 11101: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 11110 in this file
// 11011: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 11110 in this file

// 10111: edge_type_t, edge_t, edge_time_t, edge_time_t
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<
      thrust::tuple<edge_type_t const*, edge_t const*, edge_time_t const*, edge_time_t const*>>,
    thrust::tuple<edge_type_t, edge_t, edge_time_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);
...
// 11010: edge_type_t, weight_t, edge_time_t - duplicate of 11100 in this file
// 11001: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 11010 in this file

// 10110: edge_type_t, edge_t, edge_time_t
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_type_t const*, edge_t const*, edge_time_t const*>>,
    thrust::tuple<edge_type_t, edge_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);

// 10101: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 10110 in this file
// 10011: edge_type_t, edge_time_t, edge_time_t - duplicate of 10110 in this file
...
// 01101: weight_t, edge_t, edge_time_t - duplicate of 01110 in this file
// 01011: weight_t, edge_time_t, edge_time_t - duplicate of 01110 in this file

// 00111: edge_t, edge_time_t, edge_time_t
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_t const*, edge_time_t const*, edge_time_t const*>>,
    thrust::tuple<edge_t, edge_time_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_type_t const*, edge_t const*>>,
    thrust::tuple<edge_type_t, edge_t>> edge_value_view,
  bool do_expensive_check);

// 10010: edge_type_t, edge_time_t - duplicate of 10100 in this file
// 10001: edge_type_t, edge_time_t - duplicate of 10010 in this file
...
// 01010: weight_t, edge_time_t - duplicate of 01100 in this file
// 01001: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 01010 in this file

// 00110: edge_t, edge_time_t
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_t const*, edge_time_t const*>>,
    thrust::tuple<edge_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);

// 00101: edge_t, edge_time_t  - duplicate of 00110 in this file
// 00011: edge_time_t, edge_time_t - duplicate of 00110 in this file
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::key_bucket_t<vertex_t, tag_t, multi_gpu, false> const& key_list,
  cuda::std::optional<raft::device_span<uint8_t const>> gather_flags,
  cugraph::edge_property_view_t<edge_t, edge_type_t const*, edge_type_t> edge_value_view,
  bool do_expensive_check);
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::key_bucket_t<vertex_t, tag_t, multi_gpu, false> const& key_list,
  cuda::std::optional<raft::device_span<uint8_t const>> gather_flags,
  cugraph::edge_property_view_t<edge_t, edge_t const*, edge_t> edge_value_view,
  bool do_expensive_check);

// 00010: edge_time_t - duplicate of 10000 in this file
