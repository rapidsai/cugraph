...
// 11011: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t
...
// 10111: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t
...
// 10011: edge_type_t, edge_time_t, edge_time_t
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_type_t const*, edge_time_t const*, edge_time_t const*>>,
    thrust::tuple<edge_type_t, edge_time_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);
...
cugraph::detail::simple_gather_one_hop_edgelist(
  ...
  cugraph::edge_property_view_t<
    edge_t,
    thrust::zip_iterator<thrust::tuple<edge_type_t const*, edge_time_t const*>>,
    thrust::tuple<edge_type_t, edge_time_t>> edge_value_view,
  bool do_expensive_check);
...
// 00011: edge_time_t, edge_time_t - duplicate of 10010 in this file
