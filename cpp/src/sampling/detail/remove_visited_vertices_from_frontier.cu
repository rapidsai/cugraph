...
remove_visited_vertices_from_frontier(
  ...
  rmm::device_uvector<int32_t>&& frontier_vertex_labels,
  rmm::device_uvector<int32_t> const& vertices_used_as_source,
  rmm::device_uvector<int32_t> const& vertex_labels_used_as_source);
...
remove_visited_vertices_from_frontier(
  ...
  rmm::device_uvector<int32_t>&& frontier_vertex_labels,
  rmm::device_uvector<int64_t> const& vertices_used_as_source,
  rmm::device_uvector<int32_t> const& vertex_labels_used_as_source);
