...
// 11010: edge_type_t, weight_t, edge_time_t - duplicate of 11100 in this file0
...
// 01011: edge_type_t, weight_t, edge_t, edge_time_t, edge_time_t - duplicate of 01110 in this file
...
// 00010: edge_time_t - duplicate of 00100 in this file
// 00001: edge_time_t - duplicate of 00010 in this file

// 00000:

template std::tuple<rmm::device_uvector<vertex_t>, rmm::device_uvector<vertex_t>>
cugraph::detail::simple_gather_one_hop_edgelist(
  raft::handle_t const& handle,
  cugraph::graph_view_t<vertex_t, edge_t, false, multi_gpu> const& graph_view,
  cugraph::key_bucket_t<vertex_t, tag_t, multi_gpu, false> const& key_list,
