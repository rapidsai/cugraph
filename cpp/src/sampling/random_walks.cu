...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int32_t, int32_t, float, false> const& gview,
...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int32_t, int64_t, float, false> const& gview,
               int32_t const* ptr_d_start,
               int64_t num_paths,
               int64_t max_depth,
               bool use_padding,
...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int64_t, int64_t, float, false> const& gview,
...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int32_t, int32_t, double, false> const& gview,
               int32_t const* ptr_d_start,
               int32_t num_paths,
               int32_t max_depth,
               bool use_padding,
...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int32_t, int64_t, double, false> const& gview,
               int32_t const* ptr_d_start,
               int64_t num_paths,
               int64_t max_depth,
               bool use_padding,
...
template std::
  ...
  random_walks(raft::handle_t const& handle,
               graph_view_t<int64_t, int64_t, double, false> const& gview,
               int64_t const* ptr_d_start,
               int64_t num_paths,
               int64_t max_depth,
               bool use_padding,
