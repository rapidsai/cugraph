...
biased_random_walks(raft::handle_t const& handle,
                    graph_view_t<int32_t, int32_t, false, true> const& graph_view,
                    edge_property_view_t<int32_t, float const*> edge_weights,
                    raft::device_span<int32_t const> start_vertices,
                    size_t max_length,
                    uint64_t seed);
...
biased_random_walks(raft::handle_t const& handle,
                    graph_view_t<int32_t, int64_t, false, true> const& graph_view,
                    edge_property_view_t<int64_t, float const*> edge_weights,
                    raft::device_span<int32_t const> start_vertices,
                    size_t max_length,
                    uint64_t seed);
...
biased_random_walks(raft::handle_t const& handle,
                    graph_view_t<int32_t, int32_t, false, true> const& graph_view,
                    edge_property_view_t<int32_t, double const*> edge_weights,
                    raft::device_span<int32_t const> start_vertices,
                    size_t max_length,
                    uint64_t seed);
...
biased_random_walks(raft::handle_t const& handle,
                    graph_view_t<int32_t, int64_t, false, true> const& graph_view,
                    edge_property_view_t<int64_t, double const*> edge_weights,
                    raft::device_span<int32_t const> start_vertices,
                    size_t max_length,
                    uint64_t seed);
