...
// Definitions live in neighbor_sampling_*.cu; suppress hidden implicit
// instantiations from specialized temporal wrappers in this TU.
extern template std::tuple<rmm::device_uvector<int64_t>,
