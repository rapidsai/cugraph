...
template CUGRAPH_EXPORT edge_property_t<int64_t, float> edge_betweenness_centrality(
...
template CUGRAPH_EXPORT edge_property_t<int64_t, double> edge_betweenness_centrality(
  const raft::handle_t& handle,
  graph_view_t<int64_t, int64_t, false, false> const& graph_view,
  std::optional<edge_property_view_t<int64_t, double const*>> edge_weight_view,
  std::optional<raft::device_span<int64_t const>> vertices,
