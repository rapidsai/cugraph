...
template std::tuple<std::optional<rmm::device_uvector<float>>, centrality_algorithm_metadata_t>
pagerank(raft::handle_t const& handle,
         ...
         std::optional<std::tuple<raft::device_span<int32_t const>, raft::device_span<float const>>>
           personalization,
         std::optional<raft::device_span<float>> initial_pageranks,
         float alpha,
         float epsilon,
         size_t max_iterations,
         bool do_expensive_check);

template std::tuple<std::optional<rmm::device_uvector<double>>, centrality_algorithm_metadata_t>
pagerank(
  ...
  std::optional<std::tuple<raft::device_span<int32_t const>, raft::device_span<double const>>>
    personalization,
  std::optional<raft::device_span<double>> initial_pageranks,
  double alpha,
  double epsilon,
  size_t max_iterations,
  bool do_expensive_check);
