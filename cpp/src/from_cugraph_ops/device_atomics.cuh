...
/**
 * @defgroup AtomicAdd Device atomic additions
 * @{
 *
 * @tparam DataT data type
 */
template <typename DataT>
__device__ inline DataT atomic_add(DataT* address, DataT val)
{
  return atomicAdd(address, val);
}
template <>
__device__ inline int64_t atomic_add(int64_t* address, int64_t val)
{
  // unsigned long long is necessary due to how CUDA atomics work
  ...
  return atomicAdd(address_as_u64, *val_as_u64);
}
template <>
__device__ inline uint64_t atomic_add(uint64_t* address, uint64_t val)
{
  using u64_t          = unsigned long long;  // NOLINT(google-runtime-int)
  auto* val_as_u64     = reinterpret_cast<u64_t*>(&val);
  auto* address_as_u64 = reinterpret_cast<u64_t*>(address);
...
/**
 * @defgroup AtomicExch Device atomic exchange operation
 *
 * @{
 */
template <typename DataT>
__device__ inline DataT atomic_exch(DataT* address, DataT val)
{
  return atomicExch(address, val);
}
template <>
__device__ inline int64_t atomic_exch(int64_t* address, int64_t val)
{
  using u64_t          = unsigned long long;  // NOLINT(google-runtime-int)
  auto* val_as_u64     = reinterpret_cast<u64_t*>(&val);
  auto* address_as_u64 = reinterpret_cast<u64_t*>(address);
  auto ret             = atomicExch(address_as_u64, *val_as_u64);
  return *reinterpret_cast<int64_t*>(&ret);
}
template <>
__device__ inline uint64_t atomic_exch(uint64_t* address, uint64_t val)
{
  using u64_t          = unsigned long long;  // NOLINT(google-runtime-int)
  auto* val_as_u64     = reinterpret_cast<u64_t*>(&val);
  auto* address_as_u64 = reinterpret_cast<u64_t*>(address);
...
/**
 * @defgroup AtomicOr Device atomic OR operation
 *
 * @{
 */
template <typename DataT>
__device__ inline DataT atomic_or(DataT* address, DataT val)
{
  return atomicOr(address, val);
}
template <>
__device__ inline int64_t atomic_or(int64_t* address, int64_t val)
{
  using u64_t          = unsigned long long;  // NOLINT(google-runtime-int)
  auto* val_as_u64     = reinterpret_cast<u64_t*>(&val);
  auto* address_as_u64 = reinterpret_cast<u64_t*>(address);
  auto ret             = atomicOr(address_as_u64, *val_as_u64);
  return *reinterpret_cast<int64_t*>(&ret);
}
template <>
__device__ inline uint64_t atomic_or(uint64_t* address, uint64_t val)
{
  using u64_t          = unsigned long long;  // NOLINT(google-runtime-int)
  auto* val_as_u64     = reinterpret_cast<u64_t*>(&val);
  auto* address_as_u64 = reinterpret_cast<u64_t*>(address);
