  ...
  visit_graph(graph_envelope_t::base_graph_t const& graph)
{
  ...
  if constexpr (mg == false) {
    ...
    CUGRAPH_EXPECTS(
      gview.storage_transposed(),
      "Invalid input arugment: gview.storage_transposed() should be false for random walks.");
...
// EIDir's:
//
template class rw_visitor<int, int, float, true>;
template class rw_visitor<int, int, double, true>;

template class rw_visitor<int, int, float, false>;
template class rw_visitor<int, int, double, false>;

//------

template class rw_visitor<int, long, float, true>;
template class rw_visitor<int, long, double, true>;

template class rw_visitor<int, long, float, false>;
template class rw_visitor<int, long, double, false>;

//------

template class rw_visitor<long, long, float, true>;
template class rw_visitor<long, long, double, true>;

template class rw_visitor<long, long, float, false>;
template class rw_visitor<long, long, double, false>;
