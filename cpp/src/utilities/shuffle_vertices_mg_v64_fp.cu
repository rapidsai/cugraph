...
template std::
  tuple<rmm::device_uvector<int64_t>, rmm::device_uvector<float>, rmm::device_uvector<int32_t>>
...
template std::
  tuple<rmm::device_uvector<int64_t>, rmm::device_uvector<double>, rmm::device_uvector<int32_t>>
  shuffle_ext_vertex_values_pairs_to_local_gpu_by_vertex_partitioning(
    raft::handle_t const& handle,
    rmm::device_uvector<int64_t>&& vertices,
