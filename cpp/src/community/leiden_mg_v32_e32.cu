...
template CUGRAPH_EXPORT std::pair<std::unique_ptr<Dendrogram<int32_t>>, float> leiden(
...
template CUGRAPH_EXPORT std::pair<std::unique_ptr<Dendrogram<int32_t>>, double> leiden(
  raft::handle_t const& handle,
  raft::random::RngState& rng_state,
  graph_view_t<int32_t, int32_t, false, true> const& graph_view,
