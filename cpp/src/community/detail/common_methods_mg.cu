...
template float compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int32_t, int32_t, float, false, true>,
                                int32_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int32_t, int32_t, float, false, true>,
...
template float compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int32_t, int64_t, float, false, true>,
                                int32_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int32_t, int64_t, float, false, true>,
                                int32_t> const& dst_clusters_cache,
  rmm::device_uvector<int32_t> const& next_clusters,
  rmm::device_uvector<float> const& cluster_weights,
  float total_edge_weight,
...
template float compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int64_t, int64_t, float, false, true>,
                                int64_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int64_t, int64_t, float, false, true>,
...
template double compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int32_t, int32_t, double, false, true>,
                                int32_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int32_t, int32_t, double, false, true>,
                                int32_t> const& dst_clusters_cache,
  rmm::device_uvector<int32_t> const& next_clusters,
...
template double compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int32_t, int64_t, double, false, true>,
                                int32_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int32_t, int64_t, double, false, true>,
                                int32_t> const& dst_clusters_cache,
  rmm::device_uvector<int32_t> const& next_clusters,
  rmm::device_uvector<double> const& cluster_weights,
  double total_edge_weight,
...
template double compute_modularity(
  ...
  edge_partition_src_property_t<cugraph::graph_view_t<int64_t, int64_t, double, false, true>,
                                int64_t> const& src_clusters_cache,
  edge_partition_dst_property_t<cugraph::graph_view_t<int64_t, int64_t, double, false, true>,
                                int64_t> const& dst_clusters_cache,
  rmm::device_uvector<int64_t> const& next_clusters,
  rmm::device_uvector<double> const& cluster_weights,
  double total_edge_weight,
