...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int32_t, int32_t, float, false, false>, int32_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int32_t, int32_t, float, false, false>, int32_t>&
    dst_clusters_cache,
  bool up_down);
...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int32_t, int64_t, float, false, false>, float> const&
    src_vertex_weights_cache,
  edge_src_property_t<cugraph::graph_view_t<int32_t, int64_t, float, false, false>, int32_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int32_t, int64_t, float, false, false>, int32_t>&
    dst_clusters_cache,
  bool up_down);
...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int64_t, int64_t, float, false, false>, float> const&
    src_vertex_weights_cache,
  edge_src_property_t<cugraph::graph_view_t<int64_t, int64_t, float, false, false>, int64_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int64_t, int64_t, float, false, false>, int64_t>&
    dst_clusters_cache,
  bool up_down);
...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int32_t, int32_t, double, false, false>, double> const&
    src_vertex_weights_cache,
  edge_src_property_t<cugraph::graph_view_t<int32_t, int32_t, double, false, false>, int32_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int32_t, int32_t, double, false, false>, int32_t>&
    dst_clusters_cache,
  bool up_down);
...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int32_t, int64_t, double, false, false>, double> const&
    src_vertex_weights_cache,
  edge_src_property_t<cugraph::graph_view_t<int32_t, int64_t, double, false, false>, int32_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int32_t, int64_t, double, false, false>, int32_t>&
    dst_clusters_cache,
  bool up_down);
...
template void update_by_delta_modularity(
  ...
  edge_src_property_t<cugraph::graph_view_t<int64_t, int64_t, double, false, false>, double> const&
    src_vertex_weights_cache,
  edge_src_property_t<cugraph::graph_view_t<int64_t, int64_t, double, false, false>, int64_t>&
    src_clusters_cache,
  edge_dst_property_t<cugraph::graph_view_t<int64_t, int64_t, double, false, false>, int64_t>&
    dst_clusters_cache,
  bool up_down);
