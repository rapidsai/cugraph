  ...
  bool up_down)
{
  ...
  while (true) {
    ...
    // if (debug)
    //   raft::print_device_vector(
    //     "srcs", thrust::get<0>(edge_begin.get_iterator_tuple()), num_vertices, std::cout);
    ...
    // if (debug) raft::print_device_vector("vertex_begin", vertex_begin, num_vertices, std::cout);
