...
refine_clustering(
  ...
  edge_src_property_t<typename graph_view_t::vertex_type,
                      weight_t,
                      graph_view_t::is_storage_transposed> const& src_vertex_weights_cache,
  edge_src_property_t<typename graph_view_t::vertex_type,
                      typename graph_view_t::vertex_type,
                      graph_view_t::is_storage_transposed> const& src_clusters_cache,
  edge_dst_property_t<typename graph_view_t::vertex_type,
                      typename graph_view_t::vertex_type,
                      graph_view_t::is_storage_transposed> const& dst_clusters_cache);
