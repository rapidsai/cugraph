        ...
        bool do_expensive_check)
{
...

  {
    ...
    std::chrono::duration<double, std::milli> triangle_count_ms = duration_cast<milliseconds> (s);
    std::chrono::duration<double, std::milli> ext_w_edges_ms = duration_cast<milliseconds> (s);
    std::chrono::duration<double, std::milli> edge_mask_ms = duration_cast<milliseconds> (s);
    ...
    while (true) {
      ...
      triangle_count_ms += duration_cast<milliseconds>(stop - start);
      ...
      edge_mask_ms += duration_cast<milliseconds>(stop - start);
    ...
    std::cout << "edge triangle count took " << triangle_count_ms.count() << " milliseconds" << std::endl;
    std::cout << "weak edge extraction took " << ext_w_edges_ms.count() << " milliseconds" << std::endl;
    std::cout << "edge masking took " << edge_mask_ms.count() << " milliseconds" << std::endl;
