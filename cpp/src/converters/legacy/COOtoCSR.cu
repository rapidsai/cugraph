...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<uint32_t, uint32_t, float>>
...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<uint32_t, uint32_t, double>>
...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<int32_t, int32_t, float>>
...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<int32_t, int32_t, double>>
...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<int64_t, int64_t, float>>
...
template CUGRAPH_EXPORT std::unique_ptr<legacy::GraphCSR<int64_t, int64_t, double>>
