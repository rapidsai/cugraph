...
template std::tuple<
  ...
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, false, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, false, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, false, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, false, false>, int32_t>>,
...
template std::tuple<
  ...
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, true, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, true, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, true, false>, int32_t>>,
  std::optional<edge_property_t<graph_view_t<int32_t, int32_t, true, false>, int32_t>>,
  std::optional<rmm::device_uvector<int32_t>>>
