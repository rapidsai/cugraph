...
template void unrenumber_sorted_unique_local_int_edge_dsts<int64_t, false, true>(
  raft::handle_t const& handle,
...
template void unrenumber_sorted_unique_local_int_edge_dsts<int64_t, true, true>(
  raft::handle_t const& handle,
  raft::device_span<int64_t> sorted_unique_edge_dsts /* [INOUT] */,
  raft::device_span<int64_t const> renumber_map,
  std::vector<int64_t> const& vertex_partition_range_lasts,
