...
template std::tuple<rmm::device_uvector<int32_t>,
                    ...
                    std::optional<rmm::device_uvector<int32_t>>,
                    std::optional<rmm::device_uvector<int32_t>>>
symmetrize_edgelist<int32_t, int32_t, float, int32_t, int32_t, false>(
  raft::handle_t const& handle,
  rmm::device_uvector<int32_t>&& edgelist_srcs,
  rmm::device_uvector<int32_t>&& edgelist_dsts,
  std::optional<rmm::device_uvector<float>>&& edgelist_weights,
...
template std::tuple<rmm::device_uvector<int32_t>,
                    ...
                    std::optional<rmm::device_uvector<int32_t>>,
                    std::optional<rmm::device_uvector<int32_t>>>
symmetrize_edgelist<int32_t, int32_t, double, int32_t, int32_t, false>(
  raft::handle_t const& handle,
  rmm::device_uvector<int32_t>&& edgelist_srcs,
  rmm::device_uvector<int32_t>&& edgelist_dsts,
  std::optional<rmm::device_uvector<double>>&& edgelist_weights,
...
template std::tuple<rmm::device_uvector<int32_t>,
                    ...
                    std::optional<rmm::device_uvector<int64_t>>>
symmetrize_edgelist<int32_t, int32_t, float, int32_t, int64_t, false>(
  raft::handle_t const& handle,
  rmm::device_uvector<int32_t>&& edgelist_srcs,
  rmm::device_uvector<int32_t>&& edgelist_dsts,
  std::optional<rmm::device_uvector<float>>&& edgelist_weights,
...
template std::tuple<rmm::device_uvector<int32_t>,
                    ...
                    std::optional<rmm::device_uvector<int64_t>>,
                    std::optional<rmm::device_uvector<int64_t>>>
symmetrize_edgelist<int32_t, int32_t, double, int32_t, int64_t, false>(
  raft::handle_t const& handle,
  rmm::device_uvector<int32_t>&& edgelist_srcs,
  rmm::device_uvector<int32_t>&& edgelist_dsts,
  std::optional<rmm::device_uvector<double>>&& edgelist_weights,
