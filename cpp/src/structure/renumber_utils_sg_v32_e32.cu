...
template void unrenumber_sorted_unique_local_int_edge_dsts<int32_t, false, false>(
  raft::handle_t const& handle,
...
template void unrenumber_sorted_unique_local_int_edge_dsts<int32_t, true, false>(
  raft::handle_t const& handle,
  raft::device_span<int32_t> sorted_unique_edge_dsts /* [INOUT] */,
  raft::device_span<int32_t const> renumber_map,
  std::vector<int32_t> const& vertex_partition_range_lasts,
