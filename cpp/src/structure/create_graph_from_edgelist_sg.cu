...
template std::tuple<
  ...
  std::optional<
    cugraph::edge_property_t<cugraph::graph_view_t<int32_t, int64_t, false, false>, int64_t>>,
  std::optional<
    cugraph::edge_property_t<cugraph::graph_view_t<int32_t, int64_t, false, false>, int32_t>>,
  std::optional<rmm::device_uvector<int32_t>>>
...
template std::tuple<
  ...
  std::optional<
    cugraph::edge_property_t<cugraph::graph_view_t<int32_t, int64_t, true, false>, int64_t>>,
  std::optional<
    cugraph::edge_property_t<cugraph::graph_view_t<int32_t, int64_t, true, false>, int32_t>>,
  std::optional<rmm::device_uvector<int32_t>>>
