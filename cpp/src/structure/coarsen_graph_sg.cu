...
template std::tuple<std::unique_ptr<graph_t<int32_t, int32_t, float, false>>,
...
template std::tuple<std::unique_ptr<graph_t<int32_t, int64_t, float, false>>,
                    rmm::device_uvector<int32_t>>
coarsen_graph(raft::handle_t const& handle,
...
template std::tuple<std::unique_ptr<graph_t<int64_t, int64_t, float, false>>,
...
template std::tuple<std::unique_ptr<graph_t<int32_t, int32_t, double, false>>,
                    rmm::device_uvector<int32_t>>
coarsen_graph(raft::handle_t const& handle,
...
template std::tuple<std::unique_ptr<graph_t<int32_t, int64_t, double, false>>,
                    rmm::device_uvector<int32_t>>
coarsen_graph(raft::handle_t const& handle,
...
template std::tuple<std::unique_ptr<graph_t<int64_t, int64_t, double, false>>,
                    rmm::device_uvector<int64_t>>
coarsen_graph(raft::handle_t const& handle,
