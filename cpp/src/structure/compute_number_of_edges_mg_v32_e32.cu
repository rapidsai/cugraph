...
template void view_t::compute_number_of_edges_async<thrust::counting_iterator<int32_t>>(thrust::counting_iterator<int32_t>, thrust::counting_iterator<int32_t>, raft::device_span<size_t>, rmm::cuda_stream_view) const;

// compute_local_degrees (MajorIterator)
template rmm::device_uvector<int32_t> view_t::compute_local_degrees<int32_t*>(int32_t*, int32_t*, rmm::cuda_stream_view) const;
...
template void view_t::compute_number_of_edges_async<bitmap_iter_32_t>(bitmap_iter_32_t, bitmap_iter_32_t, raft::device_span<size_t>, rmm::cuda_stream_view) const;
