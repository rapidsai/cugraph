...
// bitmap iterator
using bitmap_iter_32_t =
  cuda::transform_iterator<detail::bitmap_offset_to_vertex_op_t<int32_t>, uint32_t const*>;
template void view_t::compute_number_of_edges_with_mask_async<uint32_t const*, bitmap_iter_32_t>(
  uint32_t const*,
  bitmap_iter_32_t,
  bitmap_iter_32_t,
  raft::device_span<size_t>,
...
using sh_iter_32_t = cuda::transform_iterator<detail::sparse_hypersparse_major_op_t<int32_t>,
                                              thrust::counting_iterator<int32_t>>;
template rmm::device_uvector<int32_t>
view_t::compute_local_degrees_with_mask<uint32_t const*, sh_iter_32_t>(uint32_t const*,
                                                                       sh_iter_32_t,
                                                                       sh_iter_32_t,
                                                                       rmm::cuda_stream_view) const;
