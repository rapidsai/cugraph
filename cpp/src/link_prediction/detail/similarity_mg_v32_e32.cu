...
template CUGRAPH_EXPORT rmm::device_uvector<float> similarity<int32_t, int32_t, float, true>(
...
template CUGRAPH_EXPORT rmm::device_uvector<double> similarity<int32_t, int32_t, double, true>(
  raft::handle_t const& handle,
  graph_view_t<int32_t, int32_t, false, true> const& graph_view,
