...
template CUGRAPH_EXPORT rmm::device_uvector<float> similarity<int64_t, int64_t, float, false>(
...
template CUGRAPH_EXPORT rmm::device_uvector<double> similarity<int64_t, int64_t, double, false>(
  raft::handle_t const& handle,
  graph_view_t<int64_t, int64_t, false, false> const& graph_view,
...
template CUGRAPH_EXPORT
  ...
  all_pairs_similarity<int64_t, int64_t, float, false>(
    raft::handle_t const& handle,
    graph_view_t<int64_t, int64_t, false, false> const& graph_view,
    std::optional<edge_property_view_t<int64_t, float const*>> edge_weight_view,
...
template CUGRAPH_EXPORT std::
  ...
  all_pairs_similarity<int64_t, int64_t, double, false>(
    raft::handle_t const& handle,
    graph_view_t<int64_t, int64_t, false, false> const& graph_view,
    std::optional<edge_property_view_t<int64_t, double const*>> edge_weight_view,
    std::optional<raft::device_span<int64_t const>> vertices,
