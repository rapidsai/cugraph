...
template void jaccard<int32_t, int32_t, float>(
  GraphCSRView<int32_t, int32_t, float> const &, float const *, float *);
template void jaccard<int32_t, int32_t, double>(
  GraphCSRView<int32_t, int32_t, double> const &, double const *, double *);
template void jaccard<int64_t, int64_t, float>(
  GraphCSRView<int64_t, int64_t, float> const &, float const *, float *);
template void jaccard<int64_t, int64_t, double>(
  GraphCSRView<int64_t, int64_t, double> const &, double const *, double *);
...
template void jaccard_list<int64_t, int64_t, float>(
  GraphCSRView<int64_t, int64_t, float> const &,
  float const *,
  int64_t,
  int64_t const *,
  int64_t const *,
...
template void jaccard_list<int64_t, int64_t, double>(
  GraphCSRView<int64_t, int64_t, double> const &,
  double const *,
  int64_t,
  int64_t const *,
  int64_t const *,
