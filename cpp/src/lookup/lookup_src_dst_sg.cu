...
template CUGRAPH_EXPORT class lookup_container_t<int32_t, int32_t, int32_t>;
template CUGRAPH_EXPORT class lookup_container_t<int64_t, int32_t, int32_t>;
template CUGRAPH_EXPORT class lookup_container_t<int64_t, int32_t, int64_t>;

template CUGRAPH_EXPORT lookup_container_t<int32_t, int32_t, int32_t>
...
template CUGRAPH_EXPORT lookup_container_t<int64_t, int32_t, int32_t>
build_edge_id_and_type_to_src_dst_lookup_map(
  raft::handle_t const& handle,
...
template CUGRAPH_EXPORT lookup_container_t<int64_t, int32_t, int64_t>
build_edge_id_and_type_to_src_dst_lookup_map(
  raft::handle_t const& handle,
