...
lookup_src_dst_from_edge_id_and_type<int32_t, int32_t, int32_t, false>(
  raft::handle_t const& handle,
...
template std::tuple<rmm::device_uvector<int32_t>, rmm::device_uvector<int32_t>>
lookup_src_dst_from_edge_id_and_type<int32_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
...
lookup_src_dst_from_edge_id_and_type<int64_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
