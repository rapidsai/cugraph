...
lookup_endpoints_for_edge_ids_of_single_type<int32_t, int32_t, int32_t, false>(
  raft::handle_t const& handle,
...
template std::tuple<rmm::device_uvector<int32_t>, rmm::device_uvector<int32_t>>
lookup_endpoints_for_edge_ids_and_types<int32_t, int32_t, int32_t, false>(
  raft::handle_t const& handle,
  lookup_container_t<int32_t, int32_t, thrust::tuple<int32_t, int32_t>> const& search_container,
  raft::device_span<int32_t const> edge_ids_to_lookup,
...
template std::tuple<rmm::device_uvector<int32_t>, rmm::device_uvector<int32_t>>
lookup_endpoints_for_edge_ids_of_single_type<int32_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
  lookup_container_t<int64_t, int32_t, thrust::tuple<int32_t, int32_t>> const& search_container,
  raft::device_span<int64_t const> edge_ids_to_lookup,
  int32_t edge_type_to_lookup);

template std::tuple<rmm::device_uvector<int32_t>, rmm::device_uvector<int32_t>>
lookup_endpoints_for_edge_ids_and_types<int32_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
  lookup_container_t<int64_t, int32_t, thrust::tuple<int32_t, int32_t>> const& search_container,
  raft::device_span<int64_t const> edge_ids_to_lookup,
  raft::device_span<int32_t const> edge_types_to_lookup);

template lookup_container_t<int64_t, int32_t, thrust::tuple<int64_t, int64_t>>
build_edge_id_and_type_to_src_dst_lookup_map(
  raft::handle_t const& handle,
...
lookup_endpoints_for_edge_ids_of_single_type<int64_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
  lookup_container_t<int64_t, int32_t, thrust::tuple<int64_t, int64_t>> const& search_container,
  raft::device_span<int64_t const> edge_ids_to_lookup,
  int32_t edge_type_to_lookup);
template std::tuple<rmm::device_uvector<int64_t>, rmm::device_uvector<int64_t>>
lookup_endpoints_for_edge_ids_and_types<int64_t, int64_t, int32_t, false>(
  raft::handle_t const& handle,
  lookup_container_t<int64_t, int32_t, thrust::tuple<int64_t, int64_t>> const& search_container,
  raft::device_span<int64_t const> edge_ids_to_lookup,
  raft::device_span<int32_t const> edge_types_to_lookup);
