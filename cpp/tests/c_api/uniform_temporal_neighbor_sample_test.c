...
int test_uniform_temporal_neighbor_sample_fixed_window_multihop(
  const cugraph_resource_handle_t* handle)
{
  size_t num_edges        = 3;
  size_t num_vertices     = 4;
...
int test_uniform_temporal_neighbor_sample_first_single_hop(const cugraph_resource_handle_t* handle)
{
  size_t num_edges        = 3;
  size_t num_vertices     = 4;
  size_t fan_out_size     = 1;
  ...
  // Star from seed 0 with three outgoing edges at distinct times. FIRST with fan_out=1 must pick
  // the earliest eligible edge.
  vertex_t src[]                          = {0, 0, 0};
  vertex_t dst[]                          = {1, 2, 3};
  edge_t edge_ids[]                       = {0, 1, 2};
  weight_t weight[]                       = {0.1, 0.2, 0.3};
...
int test_uniform_temporal_neighbor_sample_last_single_hop(const cugraph_resource_handle_t* handle)
{
  size_t num_edges        = 3;
  size_t num_vertices     = 4;
  size_t fan_out_size     = 1;
  ...
  // Same star as FIRST; LAST with fan_out=1 must pick the latest eligible edge.
  vertex_t src[]                          = {0, 0, 0};
  vertex_t dst[]                          = {1, 2, 3};
  edge_t edge_ids[]                       = {0, 1, 2};
  weight_t weight[]                       = {0.1, 0.2, 0.3};
...
int test_uniform_temporal_neighbor_sample_fixed_window_first(
  const cugraph_resource_handle_t* handle)
{
  size_t num_edges        = 3;
  size_t num_vertices     = 4;
  ...
  // FIXED_WINDOW keeps seed window [10, 100] at hop 1, so both 1->2 (t=30) and 1->3 (t=80) are
  // eligible. FIRST with fan_out={-1,1} takes the earliest of those at hop 1.
  vertex_t src[]                          = {0, 1, 1};
  vertex_t dst[]                          = {1, 2, 3};
  edge_t edge_ids[]                       = {0, 1, 2};
  weight_t weight[]                       = {0.1, 0.2, 0.3};
...
int test_uniform_temporal_neighbor_sample_fixed_window_last(const cugraph_resource_handle_t* handle)
{
  size_t num_edges        = 3;
  size_t num_vertices     = 4;
  size_t fan_out_size     = 2;
  ...
  // Same FIXED_WINDOW graph as FIRST; LAST picks the latest eligible hop-1 edge.
  vertex_t src[]                          = {0, 1, 1};
  vertex_t dst[]                          = {1, 2, 3};
  edge_t edge_ids[]                       = {0, 1, 2};
  weight_t weight[]                       = {0.1, 0.2, 0.3};
...
int main(int argc, char** argv)
{
  ...
  result |= RUN_TEST_NEW(test_uniform_temporal_neighbor_sample_first_single_hop, handle);
  result |= RUN_TEST_NEW(test_uniform_temporal_neighbor_sample_last_single_hop, handle);
  result |= RUN_TEST_NEW(test_uniform_temporal_neighbor_sample_fixed_window_first, handle);
  result |= RUN_TEST_NEW(test_uniform_temporal_neighbor_sample_fixed_window_last, handle);
