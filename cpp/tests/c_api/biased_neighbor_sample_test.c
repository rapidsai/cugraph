...
int main(int argc, char** argv)
{
  ...
  int result = 0;
  result |= RUN_TEST_NEW(test_biased_neighbor_sample_clean, handle);
  result |= RUN_TEST_NEW(test_biased_neighbor_sample_dedupe_sources, handle);
  result |= RUN_TEST_NEW(test_biased_neighbor_sample_unique_sources, handle);
  result |= RUN_TEST_NEW(test_biased_neighbor_sample_carry_over_sources, handle);
  result |= RUN_TEST_NEW(test_biased_neighbor_sample_renumber_results, handle);
