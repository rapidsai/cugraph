...
template struct generate<cugraph::graph_view_t<int32_t, int64_t, false, true>, bool>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, false, true>, int32_t>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, false, true>, int64_t>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, false, true>,
                         thrust::tuple<int, float>>;

template struct generate<cugraph::graph_view_t<int32_t, int64_t, true, true>, bool>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, true, true>, int32_t>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, true, true>, int64_t>;
template struct generate<cugraph::graph_view_t<int32_t, int64_t, true, true>,
                         thrust::tuple<int, float>>;
