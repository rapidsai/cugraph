 ...
 public:
                        ...
                        input_usecase_t const& input_usecase)
  {
    ...
    if (edge_triangle_count_usecase.check_correctness_) {
      ...
      std::tie(sg_graph, std::ignore, d_sg_cugraph_results, std::ignore) = cugraph::test::mg_graph_to_sg_graph(
        *handle_,
        mg_graph_view,
...
INSTANTIATE_TEST_SUITE_P(rmat_small_tests,
                         ...
                         ::testing::Combine(::testing::Values(EdgeTriangleCount_Usecase{false, false, true},
                                                              EdgeTriangleCount_Usecase{false, true, true}),
