...
class Tests_Multithreaded
 ...
 public:
    ...
    std::vector<int> gpu_list)
  {
    ...
    cugraph::mtmg::graph_t<vertex_t, true, multi_gpu> graph;
    cugraph::mtmg::graph_view_t<vertex_t, true, multi_gpu> graph_view;
    ...
    for (int i = 0; i < num_local_gpus; ++i) {
      running_threads.emplace_back([&instance_manager,
        ...
        cugraph::mtmg::create_graph_from_edgelist<vertex_t, true, multi_gpu>(
          thread_handle,
          edgelist,
