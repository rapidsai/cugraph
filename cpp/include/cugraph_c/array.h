 ...
 * @return error code
 */
cugraph_error_t cugraph_type_erased_device_array_create(const cugraph_raft_handle_t* handle,
 ...
 */
cugraph_error_t cugraph_type_erased_host_array_create(const cugraph_raft_handle_t* handle,
                                                      data_type_id_t dtype,
                                                      size_t n_elems,
