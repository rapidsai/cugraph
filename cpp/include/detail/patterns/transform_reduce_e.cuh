...
template <typename GraphType,
          ...
          typename EdgeOp>
__global__
void for_all_major_for_all_nbr_low_out_degree(
    GraphType graph_device_view,
    MajorIterator major_first, MajorIterator major_last,
...
T transform_reduce_e(
  ...
  >>>(
    graph,
    GraphType::is_row_major
      ? graph.this_partition_adj_matrix_row_begin()
      : graph.this_partition_adj_matrix_col_begin(),
    GraphType::is_row_major
      ? graph.this_partition_adj_matrix_row_end()
