 ...
 */
template <typename VT, typename ET, typename WT> class GraphViewBase {
public:
  ...
  GraphViewBase(WT *edge_data_, VT number_of_vertices_, ET number_of_edges_)
      : edge_data(edge_data_), prop(), number_of_vertices(number_of_vertices_),
...
public:
  ...
  GraphCSRView(ET *offsets_, VT *indices_, WT *edge_data_,
      ...
      : GraphCompressedSparseBaseView<VT, ET, WT>(
            offsets_, indices_, edge_data_, number_of_vertices_,
            number_of_edges_) {}
};
 ...
 * @param  number_of_edges       The number of edges in the graph
 */
template <typename VT, typename ET, typename WT> struct GraphCOOContents {
  VT number_of_vertices;
  ET number_of_edges;
 ...
 * @tparam WT   Type of weight
 */
template <typename VT, typename ET, typename WT> class GraphCOO {
...
template <typename VT, typename ET, typename WT> struct GraphSparseContents {
  VT number_of_vertices;
  ET number_of_edges;
