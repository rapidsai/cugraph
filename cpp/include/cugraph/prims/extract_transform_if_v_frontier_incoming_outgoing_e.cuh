...
/**
 * @brief Iterate over incoming edges to the current vertex frontier and extract the valid edge
 * functor outputs.
 *
...
dataframe_buffer_type_t<
  typename detail::edge_op_result_type<typename KeyBucketType::key_type,
                                       ...
                                       EdgeOp>::type>
extract_transform_if_v_frontier_incoming_e(raft::handle_t const& handle,
                                           ...
                                           bool do_expensive_check = false)
{
  ...
  std::tie(std::ignore, value_buffer) =
    detail::extract_transform_if_v_frontier_e<true, void, e_op_result_t>(handle,
                                                                         graph_view,
                                                                         frontier,
