...
/**
 * @brief Iterate over each input vertex pair and returns the common source neighbor list
 * pair in a CSC-like format
 *
 * Iterate over every vertex pair; intersect source neighbor lists of the two vertices in the
 * pair and store the result in a CSC-like format
 *
...
per_v_pair_src_nbr_intersection(raft::handle_t const& handle,
