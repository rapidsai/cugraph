...
/**
 * @brief Iterate over incoming_edges to the current vertex frontier and extract all edge functor
 * outputs.
 *
                                        ...
                                        bool do_expensive_check = false)
{
  ...
  std::tie(std::ignore, value_buffer) =
    detail::extract_transform_if_v_frontier_e<true, void, e_op_result_t>(
      handle,
      graph_view,
      frontier,
