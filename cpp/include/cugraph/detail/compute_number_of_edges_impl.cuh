...
edge_partition_device_view_t<vertex_t, edge_t, multi_gpu, std::enable_if_t<multi_gpu>>::
  compute_number_of_edges(MajorIterator major_first,
...
edge_partition_device_view_t<vertex_t, edge_t, multi_gpu, std::enable_if_t<multi_gpu>>::
  compute_local_degrees(rmm::cuda_stream_view stream) const
{
...
__host__ size_t
edge_partition_device_view_t<vertex_t, edge_t, multi_gpu, std::enable_if_t<multi_gpu>>::
  compute_number_of_edges_with_mask(MaskIterator mask_first,
