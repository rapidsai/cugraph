...
```sh
docker pull rapidsai/notebooks:26.12a-cuda13-py3.13
```

And, then run a container based on the image using

```sh
docker run --rm  -it --pull always --gpus all --shm-size=1g --ulimit memlock=-1 --ulimit stack=67108864   -p 8888:8888 rapidsai/notebooks:26.12a-cuda13-py3.13
```
