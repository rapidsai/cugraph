...
```sh
docker pull rapidsai/notebooks:25.06a-cuda12.0-py3.10
```

And, then run a container based on the image using

```sh
docker run --rm  -it --pull always --gpus all --shm-size=1g --ulimit memlock=-1 --ulimit stack=67108864   -p 8888:8888 rapidsai/notebooks:25.06a-cuda12.0-py3.10
```
