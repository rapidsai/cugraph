...
ext = Extension('cuGraph',
                ...
                libraries=['cudart','cublas','cusolver','gdf'],
                language='c++',
                ...
                include_dirs = [numpy_include, CUDA['include'], '/usr/local/include/gdf', 'src', 'include','../gunrock','../gunrock/externals/moderngpu/include','../gunrock/externals/cub'],
